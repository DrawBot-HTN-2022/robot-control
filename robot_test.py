...
def main():
    ...
    # mymotortest.motor_run(GpioPins1, 0.001, 512, False, True, "half", 0)
    # mymotortest.motor_run(GpioPins2, 0.001, 512, False, True, "half", 0)
    # mymotortest.motor_run(GpioPins3, 0.001, 512, False, True, "half", 0)

    # up
    for i in range(100):
        mymotortest.motor_run(GpioPins1, 0.001, 8, True, False, "half", 0)
        mymotortest.motor_run(GpioPins2, 0.001, 8, True, False, "half", 0)
        time.sleep(0.02)

    # right
    for i in range(80):
        mymotortest.motor_run(GpioPins1, 0.001, 8, False, False, "half", 0)
        mymotortest.motor_run(GpioPins2, 0.001, 8, True, False, "half", 0)
        time.sleep(0.02)
    ...
    #         mymotortest.motor_run(GpioPins1, 0.001, 8, False, False, "half", 0)
    #     elif x == "d":
    #         mymotortest.motor_run(GpioPins2, 0.001, 8, False, False, "half", 0)
    #     # mymotortest.motor_run(GpioPins3, 0.001, 8, False, False, "half", 0)
